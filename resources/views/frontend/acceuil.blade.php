...
<head>
    ...
    <meta name="description"
        content="Bienvenue chez Lille Immo, forts de nos 15 ans d'expérience nous nous assurons de trouver LE bien qui vous convient">
...
-->
    ...
    <header id="#top">
        ...
        <!-- Back to top button -->
        <a href="#top" class="m-b-1"><i class="fa fa-arrow-up fa-lg hidden-sm-up pull-xs-right"
                aria-hidden="true"></i></a>
        <a href="#top" class="m-b-1 m-r-1"><i class="fa fa-arrow-up fa-2x hidden-sm-down pull-sm-right"
                aria-hidden="true"></i></a>
        ...
        <div class="container">
            <div class="row">
                ...
                <figure class="col-xs-5">
                    ...
                    <img src="img/logo_immo_medium.jpg" alt="logo lille immo"
                        class="img-fluid hidden-xs-down hidden-lg-up">
                        ...
                        @else
                            <li class="nav-item m-x-1">
                                <div class="alert alert-danger">
                                    Votre compte est désactivé. Veuillez contacter Naruto 7emeDuNom Email:
                                    Uzumaki@gmail.com.
                                </div>
                            </li>
                        @endif
                        ...
                        @else
                            <li class="nav-item m-x-1">
                                <button class="btn btn-primary"> <a style="color: white;"
                                        href="{{ route('register') }}">Inscription</a></button>
                            </li>
                            <li class="nav-item m-x-1">
        ...
        <div class="row">
            ...
            @can('search', \App\Models\Propertie::class)
                ...
                <aside class="col-xs-12 col-lg-3 p-y-2" id="search_form">
                    <h3 class="m-b-1 text-xs-center"><i class="fa fa-search-plus" aria-hidden="true"></i>Vous recherchez
                    </h3>
            ...
            @foreach ($biens as $bien)
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <article class="card">
                        ...
                        <figure>
                            <img src="storage/{{ $bien->image }}" class="img-fluid hidden-sm-up"
                                alt="maison bleu à vendre">
                            <img src="storage/{{ $bien->image }}" class="img-fluid hidden-xs-down hidden-lg-up"
                                alt="maison bleue à vendre">
                            <img src="storage/{{ $bien->image }}" class="img-fluid hidden-md-down"
                                alt="maison bleu à vendre">
                        </figure>
                ...
                @foreach ($results as $result)
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <article class="card">
                            ...
                            <figure>
                                <img src="product/{{ $result->image }}" class="img-fluid hidden-sm-up"
                                    alt="maison bleu à vendre">
                                <img src="product/{{ $result->image }}" class="img-fluid hidden-xs-down hidden-lg-up"
                                    alt="maison bleue à vendre">
                                <img src="product/{{ $result->image }}" class="img-fluid hidden-md-down"
                                    alt="maison bleu à vendre">
                            </figure>
                            <div class="card-block text-xs-center">
                                ...
                                <a href="#" class="card-link"><i class="fa fa-eye m-r-1"
...
-->
    ...
    <footer class="m-t-3">
        ...
        <section class="container p-t-1 p-x-1 text-xs-center">
            ...
            <p>SamaImmo c'est 5 agences réparties au travers de la métropole et toujours à votre service. Vous pouvez
                contacter l'agence la plus proche de chez vous via la rubrique nos agences ou contacter notre siège au
                03 20 ## ## ##</p>
            <!-- Footer navigation -->

            <!-- Copyright paragraphe -->
            <p>SamaImmo 2023. &copy;Une réalisation <a href="https://thomgo.github.io/portfolio/" target="_blank">Team
                    Bassen</a></p>
        </section>
...
-->
    ...
    <script>
        window.jQuery || document.write('<script src="{{ asset('js/vendor/jquery-1.12.0.min.js') }}"><\/script>')
    </script>
