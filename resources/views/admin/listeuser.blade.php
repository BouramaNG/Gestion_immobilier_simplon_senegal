                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td> {{$users->email}} </td>
                                            <td>
                                                <div class="badge badge-outline-success">{{$users->role}}</div>
                                            </td>
                                            <td>
                                                <form action="{{ route('inactive.user', ['id' => $users->id]) }}" method="post">
                                                    @csrf
                                                    @method ('post')
                                                <button class="btn btn-success">{{$users->status}}</button>
                                                </form>
                                            </td>
                                        </tr>
                                        @endforeach
