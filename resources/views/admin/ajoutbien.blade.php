...
{{session()->get('message')}}
           ...
           <div class="titre">
            <h1>Ajouter Bien</h1>
<form action="{{url('ajouter_product')}}" method="post" enctype="multipart/form-data">
    @csrf
           <div class="designe">
          <label for="">Nom du Bien</label>
          <input type="text" name="nom" id="titre" placeholder="entre le titre du produit">
           </div>

           <div class="designe">
          <label for="">Description</label>
          <input type="text" name="description" id="titre" placeholder="entre le la description ">
           </div>

           <div class="designe">
          <label for="">Category</label>
          <input type="number" name="category" id="titre" placeholder="entre le titre du produit">
           </div>

           <div class="designe">
          <label for="">Adresse</label>
          <input type="number" name="address" id="titre" min="0" placeholder="entre le titre du produit">
           </div>

           <div class="designe">
          <label for="">Status</label>
          <input type="number" name="status" id="titre" placeholder="entre le titre du produit">
           </div>

           <div class="designe">
          <label for="">Date de Publication</label>
          <input type="date" name="date" id="titre" placeholder="entre le titre du produit">
           </div>
           <div class="designe">
          <label for="">image Produit</label>
          <input type="file" name="image" id="titre" placeholder="entre le titre du produit">
           </div>
